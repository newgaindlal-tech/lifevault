      ...
      <div className="flex items-center gap-3">
        {user ? (
          ...
          <div className="flex items-center gap-2">
            <Link href="/auth/login" className="text-xs font-medium text-slate-600 hover:text-slate-900 px-3 py-1.5 rounded-md">
              Sign In
            </Link>
            <Link href="/auth/signup" className="text-xs font-medium bg-emerald-600 text-white hover:bg-emerald-700 px-3 py-1.5 rounded-md">
              Sign Up
            </Link>
          </div>
        )}
